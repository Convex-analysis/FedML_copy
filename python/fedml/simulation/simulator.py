...
from ..constants import (
    ...
    FedML_FEDERATED_OPTIMIZER_MHFL,
)
...
class SimulatorSingleProcess:
    def __init__(self, args, device, dataset, model, client_trainer=None, server_aggregator=None):
        ...
        from .sp.multi_hierarchical_FL.trainer import MultiHierFLTrainer
        ...
        elif args.federated_optimizer == FedML_FEDERATED_OPTIMIZER_MHFL:
            self.fl_trainer = MultiHierFLTrainer(args, device, dataset, model)
